...
$query = $conn->prepare("SELECT namaLengkap FROM tbl_user WHERE idUser = ?");
$query->bind_param("i", $idUser);
$query->execute();
$query->bind_result($namaLengkap);
$query->fetch();
$query->close();
?>
    ...
    <div class="container">
        ...
        <div class="d-flex">
            <span class="navbar-text text-white me-3">
                <i class="bi bi-person-circle"></i> <?= htmlspecialchars($namaLengkap ?: $_SESSION['username']); ?>
            </span>
...
<div class="container my-5">
    <div class="card shadow-lg p-4">
        <h3 class="welcome mb-2"><i class="bi bi-hand-thumbs-up"></i> Selamat datang, <?= htmlspecialchars($namaLengkap ?: $_SESSION['username']); ?>!</h3>
